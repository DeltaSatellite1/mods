function onCreate()
	...
	makeAnimatedLuaSprite('Audience2', 'W5/upperBop', -260, 214)
	...
	makeAnimatedLuaSprite('Audience', 'W5/bottomBop', 0, 119)
	...
	makeLuaSprite('floor','W5/fgsnow',-581,775)
	addLuaSprite('floor', false);

	makeAnimatedLuaSprite('springtrap', 'W5/santa', -661, 258)
