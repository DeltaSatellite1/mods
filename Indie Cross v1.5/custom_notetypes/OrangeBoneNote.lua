function onCreate()
	...
	for unnotesLength = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', unnotesLength, 'noteType') == 'OrangeBoneNote' then
			setPropertyFromGroup('unspawnNotes', unnotesLength, 'texture', 'sans/OrangeNote_assets'); --Change texture
