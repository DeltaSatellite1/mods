...
function onStepHit()
    if enabledSystem then
        ...
        elseif songName == 'build-our-freaky-machine' then
            if curStep == 224 or curStep == 485 or curStep == 607 or curStep == 768 or curStep == 894 or curStep == 1024 or curStep == 1663 or curStep == 1600 or curStep == 1784 then
                replaceArrayBeat(1,1)
            end

            if curStep == 464 or curStep == 1008 or curStep == 1502 or curStep == 1646 or curStep == 1776 or curStep == 2032 then
                clearBeat()
            end
