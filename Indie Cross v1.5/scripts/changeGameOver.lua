...
function onCreate()
    ...
    if string.match(stage,'hall') == 'hall' then
        setPropertyFromClass('substates.GameOverSubstate', 'loopSoundName', 'sans/gameovernormal'); --put in mods/sounds/
        setPropertyFromClass('substates.PauseSubState', 'songName', 'sans/pause'); --put in mods/music/
        IndieCrossGameOverStyle = 'Sans'
    elseif string.match(stage,'factory') == 'factory' then
        setPropertyFromClass('substates.GameOverSubstate', 'characterName', 'bf-bendy-death'); --Character json file for the death animation
        setPropertyFromClass('substates.GameOverSubstate', 'deathSoundName', 'bendy/BendyGameOver'); --put in mods/sounds/
        setPropertyFromClass('substates.GameOverSubstate', 'loopSoundName', 'bendy/BendyHeartbeat'); --put in mods/music/
        setPropertyFromClass('substates.GameOverSubstate', 'endSoundName', 'bendy/BendyClick'); --put in mods/music/
...
function onGameOver()
    ...
    if not GameOverActive and IndieCrossGameOverStyle == 'Cuphead' then
        ...
        --timePercent = (curTimer/songLength * 1.07)
